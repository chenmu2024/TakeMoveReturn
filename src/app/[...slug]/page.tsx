      ...
      <article className="content-page">
        ...
        {seoPage ? (
          ...
          <>
            ...
            <section className="help-status-grid" aria-label="Help and configuration status"><article className="help-status-card"><p className="eyebrow">PREVIEW STATUS</p><h2>Read the workflow before connecting services.</h2><p>The public site is available for product and content review. Authentication, company records, imports, billing, and support actions stay disabled until their secure services are configured.</p><Link className="text-link" href="/help/contact">View support status <IconArrowRight size={16} aria-hidden="true" /></Link></article><article className="help-status-card help-status-card-muted"><p className="eyebrow">DATA BOUNDARY</p><h2>No sample activity is shown.</h2><p>Empty states are intentional: they keep the preview honest while protecting future company-scoped data from being mixed with marketing content.</p><Link className="text-link" href="/privacy">Review privacy draft <IconArrowRight size={16} aria-hidden="true" /></Link></article></section>
            <section className="help-contact-prompt"><div><p className="eyebrow">NEED MORE HELP?</p><h2>Check the support channel.</h2><p>The contact page shows whether a verified support address is available.</p></div><Link className="button" href="/help/contact">Contact Support <IconArrowRight size={18} aria-hidden="true" /></Link></section>
          </>
        ) : key === "help/contact" ? (
          <section className="help-contact"><p className="eyebrow">SUPPORT</p><h2>Contact Support</h2><p>For workspace-specific help, use the verified support channel below when it becomes available.</p>{siteConfig.supportEmail ? <a className="button" href={`mailto:${siteConfig.supportEmail}`}>Email support <IconArrowRight size={18} aria-hidden="true" /></a> : <div className="contact-note"><strong>Support contact is not available yet.</strong><p>The public preview does not accept support requests. A verified address will appear here before the service opens to customers.</p></div>}<Link className="text-link" href="/help">Back to Help Center <IconArrowRight size={16} aria-hidden="true" /></Link></section>
        ) : helpArticle ? (
